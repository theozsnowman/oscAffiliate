...
define('NAVBAR_TITLE', 'Affiliates FAQ');
define('HEADING_TITLE', 'Affliliates FAQ');

define('TEXT_INFORMATION', '' . STORE_NAME . ' has written this FAQ to give you answers to the most common questions.<br />
 For further informations please <a href="' . tep_href_link(FILENAME_AFFILIATE_CONTACT). '"> <u>contact us</u></a>.<br />
<ul>
...
<hr width ="90%">
<br />
<font color="#000000" size="3"><strong><u>Frequently asked questions</u></strong></font>
