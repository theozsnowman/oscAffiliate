...
define('TEXT_AFFILIATE_BANNERS_NOTE', '<strong>Banner Notes:</strong><ul><li>Use an image or HTML text for the banner - not both.</li><li>HTML Text has priority over an image</li></ul>');
