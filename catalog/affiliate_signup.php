...
*/
  ...
  if (isset($_POST['action'])) {
    ...
    if (!$error) {
      ...
      // Let Admin Know a new affiliate has signed up
      $new_affiliate_email = AFFILIATE_EMAIL_WELCOME ."\n\n"
      . AFFILIATE_EMAIL_TEXT ."\n"
      . "===================================================\n"
      . AFFILIATE_EMAIL_FIRSTNAME . $a_firstname . "\n"
      . AFFILIATE_EMAIL_LASTNAME . $a_lastname . "\n"
      . AFFILIATE_EMAIL_EMAIL . $a_email_address . "\n"
      . ADMIN_EMAIL_COMPANY . $a_company . "\n";
      tep_mail(STORE_OWNER, STORE_OWNER_EMAIL_ADDRESS, EMAIL_SUBJECT2, $new_affiliate_email, $name, STORE_OWNER_EMAIL_ADDRESS);
...
?>
  ...
  <div class="buttonSet">
        <td align="right" class="main"><br /> <span class="buttonAction"><?php echo tep_draw_hidden_field('action', 'process') . tep_draw_button(IMAGE_BUTTON_CONTINUE, 'triangle-1-e', null, 'primary'); ?></span></td>
  </div>
</div>
 </form>
