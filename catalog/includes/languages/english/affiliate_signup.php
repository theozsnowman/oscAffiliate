...
define('AFFILIATE_EMAIL_WELCOME', 'A new affiliate has signed up!');
define('AFFILIATE_EMAIL_TEXT', 'You have a new affiliate');
define('EMAIL_SUBJECT2', 'A new Affiliate has signed up!');
define('AFFILIATE_EMAIL_FIRSTNAME', 'First name: ');
define('AFFILIATE_EMAIL_LASTNAME', 'Last name: ');
define('AFFILIATE_EMAIL_EMAIL', 'Email addess: ');
define('ADMIN_EMAIL_COMPANY', 'Company Name: ');
?>