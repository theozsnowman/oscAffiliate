...
?>  
  <tr>
    <td class="fieldKey"><br /><?php echo CATEGORY_COMPANY; ?></td>
  </tr>
          <tr>
            <td class="fieldKey">&nbsp;<?php echo ENTRY_AFFILIATE_COMPANY; ?></td>
            <td class="fieldKey">&nbsp;
<?php
    if ($is_read_only == true) {
...
?>
          ...
          <tr>
            <td class="fieldKey">&nbsp;<?php echo ENTRY_AFFILIATE_COMPANY_TAXID; ?></td>
            <td class="fieldKey">&nbsp;
<?php
    if ($is_read_only == true) {
...
?>  
  <tr>
    <td class="fieldKey"><br /><?php echo CATEGORY_PAYMENT_DETAILS; ?></td>
  </tr>
...
?>  
          <tr>
            <td class="fieldKey">&nbsp;<?php echo ENTRY_AFFILIATE_PAYMENT_CHECK; ?></td>
            <td class="fieldKey">&nbsp;
<?php
    if ($is_read_only == true) {
...
?>  
          <tr>
            <td class="fieldKey">&nbsp;<?php echo ENTRY_AFFILIATE_PAYMENT_PAYPAL; ?></td>
            <td class="fieldKey">&nbsp;
<?php
    if ($is_read_only == true) {
...
?>  
          <tr>
            <td class="fieldKey">&nbsp;<?php echo ENTRY_AFFILIATE_PAYMENT_BANK_NAME; ?></td>
            <td class="fieldKey">&nbsp;
<?php
    if ($is_read_only == true) {
...
?>
          ...
          <tr>
            <td class="fieldKey">&nbsp;<?php echo ENTRY_AFFILIATE_PAYMENT_BANK_BRANCH_NUMBER; ?></td>
            <td class="fieldKey">&nbsp;
<?php
    if ($is_read_only == true) {
...
?>
          ...
          <tr>
            <td class="fieldKey">&nbsp;<?php echo ENTRY_AFFILIATE_PAYMENT_BANK_SWIFT_CODE; ?></td>
            <td class="fieldKey">&nbsp;
<?php
    if ($is_read_only == true) {
...
?>
          ...
          <tr>
            <td class="fieldKey">&nbsp;<?php echo ENTRY_AFFILIATE_PAYMENT_BANK_ACCOUNT_NAME; ?></td>
            <td class="fieldKey">&nbsp;
<?php
    if ($is_read_only == true) {
...
?>
          ...
          <tr>
            <td class="fieldKey">&nbsp;<?php echo ENTRY_AFFILIATE_PAYMENT_BANK_ACCOUNT_NUMBER; ?></td>
            <td class="fieldKey">&nbsp;
<?php
    if ($is_read_only == true) {
...
?> 
  <tr>
    <td class="fieldKey"><br /><?php echo CATEGORY_ADDRESS; ?></td>
  </tr>
          <tr>
...
?>
  <tr>
    <td class="fieldKey"><br /><?php echo CATEGORY_CONTACT; ?></td>
  </tr>
          <tr>
...
?>
          ...
          <tr>
            <td class="fieldKey">&nbsp;<?php echo ENTRY_AFFILIATE_HOMEPAGE; ?></td>
            <td class="fieldKey">&nbsp;
<?php
  if ($is_read_only == true) {
...
?>
  <tr>
    <td class="fieldKey"><br /><?php echo CATEGORY_PASSWORD; ?></td>
  </tr>
          <tr>
...
?>
      ...
      <tr>
        <td class="fieldKey"><strong><?php echo CATEGORY_OPTIONS; ?></strong></td>
      </tr>
          <tr>
            <td class="fieldKey">&nbsp;<?php echo ENTRY_AFFILIATE_NEWSLETTER; ?></td>
            <td class="fieldKey">&nbsp;
<?php
  if ($is_read_only == true) {
...
?>
  ...
  <tr>
    <td class="fieldKey"><br /></td>
  </tr>
          <tr>
            <td class="fieldKey">&nbsp;</td>
            <td class="fieldKey">&nbsp;
<?php 
	echo tep_draw_checkbox_field('a_agb', $value = '1', $checked = $affiliate['affiliate_agb']) . ENTRY_AFFILIATE_ACCEPT_AGB . '<strong><a href="javascript:popupWindow(\'' . tep_href_link(FILENAME_AFFILIATE_TERMS_POPUP, '', 'SSL') . '\')">' . ENTRY_AFFILIATE_ACCEPT_AGB_TEXT . '</a></strong>';
